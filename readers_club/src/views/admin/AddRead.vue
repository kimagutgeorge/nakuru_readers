<template>
    ...
    <div class="admin-panel col-flex">
        <div class="col-100">
            <p><span  class="title-label">Add Read</span></p>
        </div>
        <div class="col-100 admin-panel-body col-flex">
         <div class="col-60 col-flex">
            ...
            <div class="col-50" style="margin-top:10px">
                <label class="title-label-small">Book Cover</label>
                <input type="file" class="universal-input form-input" @change="onFileChange" accept="image/*" />
            </div>
            <div class="col-50" style="margin-top:10px">
                <label class="title-label-small">Book (File)</label>
                <input type="file" class="universal-input form-input" @change="bookChange" />
            </div>
            <div class="col-50" style="margin-top:10px">
         ...
         <div class="col-40">
            <div style="margin-left:5%" class="col-80" v-if="imageUrl">
                <p class="title-label-small">Selected Image:</p>
  ...
  onFileChange(event) {
    ...
    async addBook(){
        ...
        if(editorContent == '' || this.genre == '' || this.bookName == '' || this.productImage == '' || this.bookFile == ''){
            this.responseClass = 'my-red displayed';
        ...
        //save info
        try {
            const response = await axios.post('http://127.0.0.1:5000/add-read', formData, {
            headers: {
